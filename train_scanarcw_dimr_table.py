...
def train():
    ...
    dataset_train = MyScanARCWDataset(latent_path_root="/storage/user/huju/transferred/ws_dditnach/DeepImplicitTemplates/examples/tables_dit_manifoldplus_scanarcw_origprep_all_large_pretrainedsofas/LatentCodes/train/2000/canonical_mesh_manifoldplus/04379243",
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        default="config/dimr_stage2_table",
