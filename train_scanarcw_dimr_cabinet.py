...
def train():
    ...
    dataset_train = MyScanARCWDataset(latent_path_root=specs["latent_path_root"],
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        # default="config/dimr_stage2_bed",
        # default="config/dimr_stage2_bookshelf",
        default="config/dimr_stage2_cabinet",
