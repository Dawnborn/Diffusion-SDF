...
if __name__ == "__main__":
    ...
    if nocond:
        ...
        output_path_mesh = os.path.join(config_path, "output", ckpt, "nocond", args.mode, "mesh", "Meshes")
    else:
    ...
    dataset_test = MyScanARCWDataset(latent_path_root="/storage/user/huju/transferred/ws_dditnach/DeepImplicitTemplates/examples/tables_dit_manifoldplus_scanarcw_origprep_all_large_pretrainedsofas/LatentCodes/train/2000/canonical_mesh_manifoldplus/04379243",
                               pcd_path_root="/home/wiss/lhao/storage/user/hjp/ws_dditnach/DATA",
                               json_file_root="/home/wiss/lhao/storage/user/hjp/ws_dditnach/DATA/ScanARCW/json_files_v5",
