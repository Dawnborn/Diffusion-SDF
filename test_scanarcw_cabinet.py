...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', type=str,
                        ...
                        default="/home/wiss/lhao/storage/user/hjp/ws_dditnach/Diffusion-SDF/config/ddit_stage2_diff_cond_cabinet_train_noneighbor",
    ...
    for idx,data in tqdm(enumerate(test_dataloader)):
        ...
        if os.path.exists(lat_vec_path):
            print("load from:"+lat_vec_path)
            lat_vec = torch.load(lat_vec_path)
        else:
        ...
        if args.create_mesh:
            ...
            decoder_specs, experiment_directory = load_SDF_specs(model.specs["diffusion_model_specs"]["ddit_specs"]["wanted_category"][0], model.specs["sdf_model"])
