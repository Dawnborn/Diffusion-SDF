...
class RfSNet(nn.Module):
    ...
    def forward(self, data, training_mode='train'):
        ...
        if epoch > self.prepare_epochs:
            ...
            proposal_out = self.z_out(proposal_out) # 4*32
...
def model_fn_decorator(test=False):
        ...
        if epoch > cfg.prepare_epochs:
            ...
            if epoch > cfg.prepare_epochs_2:
                ...
                if cfg.retrieval:
                    ...
                    cluster_meshes = model.comp_net(data, phase=1, return_mesh='generate', projection_k=cfg.k_projection)['meshes'] # (nProposal_valid, ) cfg.k_projection=0
    ...
    def model_fn(batch, model, epoch):
        ...
        if cfg.use_coords: # cfg use this one, no rgb
            feats = coords_float
        ...
        voxel_feats = pointgroup_ops.voxelization(feats, v2p_map, cfg.mode)  # (M, C), float, cuda # cfg.mode 4=mean
